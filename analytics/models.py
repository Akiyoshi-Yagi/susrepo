...
class Company(models.Model):
    stock_code = models.CharField(max_length=30, blank=True, null=True)
    submission_date = models.DateField(blank=True, null=True)
    company_name = models.CharField(max_length=150)
    industry_classification = models.CharField(max_length=50, blank=True, null=True)
    sales_amount = models.CharField(max_length=30, blank=True, null=True)
    ...
    esg_score = models.CharField(max_length=30, blank=True, null=True)
...
class CharacterNum(models.Model):
    major_classification = models.CharField(max_length=20, blank=True, null=True)
    minor_classification = models.CharField(max_length=20, blank=True, null=True)
    company_number = models.IntegerField(blank=True, null=True)
    total_word_count = models.CharField(max_length=20, blank=True, null=True)
    governance_word_count = models.CharField(max_length=20, blank=True, null=True)
    strategy_word_count = models.CharField(max_length=20, blank=True, null=True)
    talent_strategy_word_count = models.CharField(max_length=20, blank=True, null=True)
    risk_management_word_count = models.CharField(max_length=20, blank=True, null=True)
    indicators_word_count = models.CharField(max_length=20, blank=True, null=True)
    talent_indicators_word_count = models.CharField(max_length=20, blank=True, null=True)
...
class WordRate(models.Model):
    ...
    filling_company = models.CharField(max_length=20, blank=True, null=True)
    filling_rate = models.CharField(max_length=20, blank=True, null=True)
    strategy_for_value_enhancement = models.CharField(max_length=20, blank=True, null=True)
    dx_in_sustainability_context = models.CharField(max_length=20, blank=True, null=True)
    sustainability_committee_established = models.CharField(max_length=20, blank=True, null=True)
    materiality_established = models.CharField(max_length=20, blank=True, null=True)
    supply_chain_transparency_and_efficiency = models.CharField(max_length=20, blank=True, null=True)
    climate_change_considered_in_business = models.CharField(max_length=20, blank=True, null=True)
    climate_related_financial_disclosure = models.CharField(max_length=20, blank=True, null=True)
    greenhouse_gas_reduction_efforts = models.CharField(max_length=20, blank=True, null=True)
    carbon_neutral_efforts = models.CharField(max_length=20, blank=True, null=True)
    scope_3_inclusion_in_analysis = models.CharField(max_length=20, blank=True, null=True)
    disability_employment_efforts = models.CharField(max_length=20, blank=True, null=True)
    engagement_survey_conducted = models.CharField(max_length=20, blank=True, null=True)
    internal_systems_respecting_human_rights = models.CharField(max_length=20, blank=True, null=True)
    diversity_respecting_hr_policy = models.CharField(max_length=20, blank=True, null=True)
    proactive_hiring_of_female_managers = models.CharField(max_length=20, blank=True, null=True)
...
class InputCategory(models.Model):
    ...
    default_sentence = models.TextField(blank=True, null=True)
